...
class Result(Scene):
    ...
    def construct(self):
        ...
        driverT = Text('Driver').move_to(headerT + LEFT*1)
        ...
        for i in range(total_records):
            ...
            pos = queryT.get_center() + self.rand_displacement()
        ...
        self.play(records_in_driver_buff[0].animate.move_to((appT.get_x(), queryT.get_y(), 0) + self.rand_displacement(0.3)))
        self.play(records_in_driver_buff[1].animate.move_to((appT.get_x(), queryT.get_y(), 0) + self.rand_displacement(0.3)))
        anims = [r.animate.move_to((appT.get_x(), queryT.get_y(), 0) + self.rand_displacement(0.3)) for r in records_in_driver_buff[2:-5]]
        ...
        self.play(FadeOut(to_discard))

        self.wait()

    #TODO play captions together with content
    def describe(self, text):
        ...
        if self.caption == None:
            ...
            self.play(ReplacementTransform(self.caption, text))
        self.caption = text
